...
class CapabilityScene extends BaseScene {
	createMaterials() {
	...
	getResponsiveScale() {
		...
		// Adjust these breakpoints and scales to your needs
		if (width < 480) {
			return 1.5 // Mobile
		} else if (width < 768) {
			return 2 // Tablet
		} else if (width < 1024) {
			return 2.5 // Small desktop
		} else {
	...
	async loadLogo() {
		const glbPath = getStaticPath('/cube-triangle-no-damage.glb')
